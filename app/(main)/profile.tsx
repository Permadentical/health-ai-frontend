            ...
            <View style={styles.profile}>
                ...
                >
                    <View style={styles.profileAvatarWrapper}>
                        <Image
                            alt=""
                            source={{ //TODO: Change this to work with any fetched imaging
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                // TODO: Handle onPress of the edit icon specifically
                            }}
                        >
            ...
            <ScrollView>
                <View style={styles.section}>
                    ...
                    >
                        ...
                        >
                            <FeatherIcon color="#fff" name="activity" size={20} />
                        </View>

                        <Text style={styles.rowLabel}>Metrics</Text>
